...
$(document).ready(function() {
    ...
    $("#update_alert_dist").click(function() {
        ...
        web_socket_arduino_data.send("rover_update_alert_distance#"+alert_dist);
    });
    ...
    $("#update_critical_dist").click(function() {
        ...
        web_socket_arduino_data.send("rover_update_critical_distance#"+critical_dist);
    });
...
function ws_manage_gyroscope() {
    ...
    web_socket_arduino_data.onmessage = function(event) {
        ...
        } else if (arduino_data["ir_left"] != null) {
            //console.log("l: " + arduino_data["ir_left"] + " r: " + arduino_data["ir_right"]);
            var right = arduino_data["ir_right"];
            var left = arduino_data["ir_left"];

            if (connection_ok)
                ws_client_local_com.send(msg);
...
function ws_update_cycle_request() {
    ...
    // setInterval(function(){
    //     web_socket_arduino_data.send("rover_hole_detectors#");
    // }, 50);
}
