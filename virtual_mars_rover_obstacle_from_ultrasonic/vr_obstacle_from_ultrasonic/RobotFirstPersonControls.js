...
var FirstPersonControls = function ( object, domElement ) {
	...
	this.onKeyDown = function ( event ) {
		...
		switch ( event.code ) {
			...
			case 'KeyH': this.rotateRight = true; break;
			case 'KeyG': this.rotateLeft = true; break;
	...
	this.onKeyUp = function ( event ) {
		...
		switch ( event.code ) {
			...
			case 'KeyH': this.rotateRight = false; break;
			case 'KeyG': this.rotateLeft = false; break;
		}
	};
